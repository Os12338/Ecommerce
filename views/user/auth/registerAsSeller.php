                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="account-content">
                                    <form action="?page=registerAsSellerCont" method="POST">
                                        <div class="single-acc-field">
                                            <label for="email">phone</label>
                                            <input type="text" id="email" name="phone" placeholder="Enter your code">
                                        </div>
                                        <div class="single-acc-field">
                                            <button type="submit">Get Licience</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
